...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineColor = 0xFF0079FF;
    ...
    protected int cancelTextColor = 0xFF0079FF;
    protected int submitTextColor = 0xFF0079FF;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0xFF0079FF;
