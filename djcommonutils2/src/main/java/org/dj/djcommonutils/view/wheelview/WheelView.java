...
import org.dj.djcommonutils.utils.DensityUtils;
...
public class WheelView extends View {
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFF0079FF;
    public static final int TEXT_COLOR_NORMAL = 0XFF555555;
    public static final int DIVIDER_COLOR = 0XFF0079FF;
    ...
    private static final float SCALE_CONTENT = 0.9F;//非中间文字用此控制高度，压扁形成3D错觉
    ...
    private boolean isSingle = false;//是否是单项选择
...
//                // 边界处理。
                ...
                if(circlePosition > visibleItemCount / 2) {
                ...
                if(isSingle) {
                    int circlePosition1 = (int) ((L + itemHeight / 2) / itemHeight);
                    if(circlePosition1 > visibleItemCount / 2) {
                        offset = (int) itemHeight;
                    } else {
                        offset = (int) -itemHeight;
                    }
                }
...
//                return super.onSingleTapUp(e);
    ...
    /**
     * @deprecated 使用{DividerConfig}代替
     */
    @Deprecated
